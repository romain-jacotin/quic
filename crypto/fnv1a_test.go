...
func Test_FNV1A_64(t *testing.T) {
	...
	*/
	if HashFNV1A_64(nil) != 0xcbf29ce484222325 {
		t.Error("HashFNV1A_64: bad hash")
	}

	if HashFNV1A_64([]byte("a")) != 0xaf63dc4c8601ec8c {
		t.Error("HashFNV1A_64: bad hash")
	}

	if HashFNV1A_64([]byte("foobar")) != 0x85944171f73967e8 {
		t.Error("HashFNV1A_64: bad hash")
	}
}
...
func Test_FNV1A_128(t *testing.T) {
	...
	*/
	if h, l := HashFNV1A_128(nil); (h != 0x6c62272e07bb0142) && (l != 0x62b821756295c58d) {
		t.Errorf("HashFNV1A_128: bad hash %x %x", h, l)
	}

	if h, l := HashFNV1A_128([]byte("a")); (h != 0xd228cb696f1a8caf) && (l != 0x78912b704e4a8964) {
		t.Error("HashFNV1A_128: bad hash")
	}

	if h, l := HashFNV1A_128([]byte("foobar")); (h != 0x343e1662793c64bf) && (l != 0x6f0d3597ba446f18) {
		t.Error("HashFNV1A_128: bad hash")
	}
}
